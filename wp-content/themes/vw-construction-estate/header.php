              ...
              <?php if( get_theme_mod( 'vw_construction_estate_call','' ) != '' || get_theme_mod( 'vw_construction_estate_call1','' ) != '') { ?>
                <div class="row">
                  ...
                  <div class="col-lg-10 col-md-9">
                    ...
                    <p class="same-lay"><a href="tel:<?php echo esc_url( get_theme_mod('vw_construction_estate_call1','') ); ?>"><?php echo esc_html(get_theme_mod('vw_construction_estate_call1',''));?></a></p>
                  </div>
                </div>
              <?php }?>
            </div>
              ...
              <?php if( get_theme_mod( 'vw_construction_estate_mail','' ) != '') { ?>
                <div class="row">
                  ...
                  <div class="col-lg-10 col-md-9">
                    ...
                    <p class="same-lay"><a href="mailto:<?php echo esc_html(get_theme_mod('vw_construction_estate_mail1',''));?>"><?php echo esc_html(get_theme_mod('vw_construction_estate_mail1',''));?></a></p>
                  </div>
                </div>
              <?php }?>        
            </div>
