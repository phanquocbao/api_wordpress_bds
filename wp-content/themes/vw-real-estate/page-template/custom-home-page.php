					...
					<div class="col-lg-4 col-md-4">
						<?php if( get_theme_mod('vw_construction_estate_contact_number') != ''){ ?>
							<div class="contact-no">
				    			<i class="<?php echo esc_attr(get_theme_mod('vw_construction_estate_contact_number_icon','fas fa-phone-square')); ?>"></i><span class="subtitle"><a href="tel:<?php echo esc_url( get_theme_mod('vw_construction_estate_contact_number','') ); ?>"><?php echo esc_html(get_theme_mod('vw_construction_estate_contact_number',''));?></a></span>
				    		</div>
				    	<?php }?>
					</div>
